...
namespace MaterialSwapperFramework.Gui.Models
{
    ...
    public abstract class MaterialFileBase
    {
        ...
        protected virtual void SetDefaults()
        {
            ...
            MaskWrites =
                MaskWriteFlags.ALBEDO
                | MaskWriteFlags.NORMAL
                | MaskWriteFlags.SPECULAR
                | MaskWriteFlags.AMBIENT_OCCLUSION
                | MaskWriteFlags.EMISSIVE
                | MaskWriteFlags.GLOSS;
        }
        #endregion
        ...
        private string AlphaBlendModeString
        {
            ...
            set =>
                AlphaBlendMode = Enum.TryParse(value, true, out AlphaBlendModeType mode)
                    ? mode
                    : AlphaBlendModeType.None;
        }
        ...
        public virtual void Deserialize(BinaryReader input)
        {
            ...
            AlphaBlendMode = ConvertAlphaBlendMode(
                alphaBlendMode0,
                alphaBlendMode1,
                alphaBlendMode2
            );
        ...
        private static void ConvertAlphaBlendMode(
            AlphaBlendModeType type,
            ref byte a,
            ref uint b,
            ref uint c
        )
